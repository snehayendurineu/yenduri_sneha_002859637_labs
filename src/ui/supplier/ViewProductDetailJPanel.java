...
public class ViewProductDetailJPanel extends javax.swing.JPanel {
    ...
    private void saveFeatures() {
       ...
       for(int i=0; i<model.getRowCount(); i++){
           Feature cf = product.getFeatures().get(i);
           cf.setName(tblFeatures.getValueAt(i, 0).toString());
           cf.setValue(tblFeatures.getValueAt(i, 1));
       }
    }
    ...
    private void btnAddFeatureActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddFeatureActionPerformed
        ...
        feature.setValue("Type value here");
