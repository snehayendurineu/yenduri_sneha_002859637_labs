...
public class CreateNewProductJPanel extends javax.swing.JPanel {
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        try{
            ...
            availVal = Integer.parseInt(txtAvail.getText());

        }catch(Exception e){
             JOptionPane.showMessageDialog(this, "Please check the product and quantity formats", "Error", JOptionPane.ERROR_MESSAGE);
             return; 
        }
